...
public class Yolcu implements YurtDisiKurallari{
    ...
    public Yolcu(){
        ...
        System.out.println("Yatırılan harç bedelini giriniz:");
        this.harc = scanner.nextInt();
        scanner.nextLine(); //dummy

        System.out.println("Herhangi bir siyasi yasağınız bulunuyor mu? ( Evet/Hayır)");
    ...
    return false;
        ...
        System.out.println("Yurtdışı harcı yatmış");
        return true;
    }
